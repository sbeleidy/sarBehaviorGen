...
def testActionScript():
    m = Misty("192.168.1.2")
    m.startSkill()
    action = [{ 'name': 'SetEyes', 'args': ['default']},
    { 'name': 'LookInDirection', 'args': ['center'] }, 
    { 'name': 'Pause','args': [7500]},
    { 'name': 'LookInDirection', 'args': ['upperRight'] }, 
    { 'name': 'Pause','args': [3500]},
    { 'name': 'SayText', 'args': ['I\'m ready!'] }, 
    { 'name': 'Pause','args': [500]}
    ]
    # action = [{ 'name': 'SetEyes', 'args': ['default']},
    # { 'name': 'Pause','args': [3500]},
    # { 'name': 'LookInDirection', 'args': ['lowerLeft'] }, 
    # { 'name': 'Pause','args': [1500]},
    # { 'name': 'LookInDirection', 'args': ['center'] }, 
    # { 'name': 'Pause','args': [1500]},
    # { 'name': 'LookInDirection', 'args': ['lowerLeft'] }, 
    # { 'name': 'Pause','args': [500]},
    # { 'name': 'SayText', 'args': ['Um...'] }, 
    # { 'name': 'LookInDirection', 'args': ['center'] }, 
    # { 'name': 'TiltHead', 'args': ['left', 'small'] },
    # { 'name': 'Pause','args': [2500]},
    # { 'name': 'LookInDirection', 'args': ['lowerLeft'] }, 
    # { 'name': 'SetEyes', 'args': ['thinking']},
    # { 'name': 'SayText', 'args': ['aaahhh...'] }, 
    # { 'name': 'Pause','args': [2500]},
    # { 'name': 'LookInDirection', 'args': ['center'] }, 
    # { 'name': 'SayText', 'args': ['What...'] }, 
    # { 'name': 'TiltHead', 'args': ['right', 'small'] },
    # { 'name': 'Pause','args': [1500]}, 
    # { 'name': 'SayText', 'args': ['What are you trying to tell me?'] }, 
    # { 'name': 'Pause','args': [4500]}, 
    # { 'name': 'LookInDirection', 'args': ['upperRight'] },  
    # { 'name': 'SetEyes', 'args': ['love']},
    # { 'name': 'Pause','args': [500]}, 
    # { 'name': 'SayText', 'args': ['OH!'] },
    # ]
